...
class thursday : AppCompatActivity()
{
    ...
    private fun createnotificationchannel1()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("15","thursday_foreground",importance1)
    ...
    private fun createnotificationchannel2()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("23","thursday_background",importance1)
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        val build1 = NotificationCompat.Builder(this,"15")
            .setContentTitle("TimeTable")
            .setContentText("Data Updated for Thursday")
            .setAutoCancel(true)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection("user data").document("user data").collection(auth.uid.toString()).document("thursday")
        ///////////////////////////////////////////////////////////////////
        ...
        {
            var intent = Intent(this@thursday,monday_data::class.java)
            startActivity(intent)
        }

        var putdata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("thursday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection("user data").document("user data").collection(auth.uid.toString()).document("thursday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("thursday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("thursday")
    ...
    {
        var ff = db.collection("user data").document("user data").collection(auth.uid.toString()).document("thursday")
        ...
        ff.get().addOnSuccessListener {
            ...
            if(document.getString("time$i")!=null)
            {
                ...
                var intent = Intent(this, thursdayalarmmanager::class.java)
                intent.putExtra("content title","Thursday Schedule")
    ...
    {
        alarmManager = getSystemService(ALARM_SERVICE) as AlarmManager
        val intent = Intent(this,thursdayalarmmanager::class.java)
