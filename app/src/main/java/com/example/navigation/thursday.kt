...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection(auth.uid.toString()).document("thursday")
        ///////////////////////////////////////////////////////////////////
        ...
        var putdata = db.collection(auth.uid.toString()).document("thursday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection(auth.uid.toString()).document("thursday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection(auth.uid.toString()).document("thursday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection(auth.uid.toString()).document("thursday")
    ...
    {
        var ff = db.collection(auth.uid.toString()).document("thursday")
