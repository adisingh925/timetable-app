...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection(auth.uid.toString()).document("wednesday")
        ///////////////////////////////////////////////////////////////////
        ...
        var putdata = db.collection(auth.uid.toString()).document("wednesday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection(auth.uid.toString()).document("wednesday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection(auth.uid.toString()).document("wednesday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection(auth.uid.toString()).document("wednesday")
    ...
    {
        var ff = db.collection(auth.uid.toString()).document("wednesday")
