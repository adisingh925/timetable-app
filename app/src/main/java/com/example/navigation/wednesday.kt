...
class wednesday : AppCompatActivity()
{
    ...
    private fun createnotificationchannel1()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("14","Wednesday_foreground",importance1)
    ...
    private fun createnotificationchannel2()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("22","Wednesday_background",importance1)
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        val build1 = NotificationCompat.Builder(this,"14")
            .setContentTitle("TimeTable")
            .setContentText("Data Updated for Wednesday")
            .setAutoCancel(true)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection("user data").document("user data").collection(auth.uid.toString()).document("wednesday")
        ///////////////////////////////////////////////////////////////////
        ...
        {
            var intent = Intent(this@wednesday,monday_data::class.java)
            startActivity(intent)
        }

        var putdata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("wednesday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection("user data").document("user data").collection(auth.uid.toString()).document("wednesday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("wednesday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("wednesday")
    ...
    {
        var ff = db.collection("user data").document("user data").collection(auth.uid.toString()).document("wednesday")
        ...
        ff.get().addOnSuccessListener {
            ...
            if(document.getString("time$i")!=null)
            {
                ...
                var intent = Intent(this, wednesdayalarmmanager::class.java)
                intent.putExtra("content title","Wednesday Schedule")
    ...
    {
        alarmManager = getSystemService(ALARM_SERVICE) as AlarmManager
        val intent = Intent(this,wednesdayalarmmanager::class.java)
