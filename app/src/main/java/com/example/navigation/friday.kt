...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection(auth.uid.toString()).document("friday")
        ///////////////////////////////////////////////////////////////////
        ...
        var putdata = db.collection(auth.uid.toString()).document("friday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection(auth.uid.toString()).document("friday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection(auth.uid.toString()).document("friday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection(auth.uid.toString()).document("friday")
    ...
    {
        var ff = db.collection(auth.uid.toString()).document("friday")
