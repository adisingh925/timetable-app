...
class friday : AppCompatActivity()
{
    ...
    private fun createnotificationchannel1()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("16","friday_foreground",importance1)
    ...
    private fun createnotificationchannel2()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("24","friday_background",importance1)
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        val build1 = NotificationCompat.Builder(this,"16")
            .setContentTitle("TimeTable")
            .setContentText("Data Updated for Friday")
            .setAutoCancel(true)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection("user data").document("user data").collection(auth.uid.toString()).document("friday")
        ///////////////////////////////////////////////////////////////////
        ...
        {
            var intent = Intent(this@friday,monday_data::class.java)
            startActivity(intent)
        }

        var putdata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("friday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection("user data").document("user data").collection(auth.uid.toString()).document("friday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("friday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("friday")
    ...
    {
        var ff = db.collection("user data").document("user data").collection(auth.uid.toString()).document("friday")
        ...
        ff.get().addOnSuccessListener {
            ...
            if(document.getString("time$i")!=null)
            {
                ...
                var intent = Intent(this, fridayalarmmanager::class.java)
                intent.putExtra("content title","Friday Schedule")
    ...
    {
        alarmManager = getSystemService(ALARM_SERVICE) as AlarmManager
        val intent = Intent(this,fridayalarmmanager::class.java)
