...
class saturday : AppCompatActivity()
{
    ...
    private fun createnotificationchannel1()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("17","saturday_foreground",importance1)
    ...
    private fun createnotificationchannel2()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            val channel1 = NotificationChannel("25","saturday_background",importance1)
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        val build1 = NotificationCompat.Builder(this,"17")
            .setContentTitle("TimeTable")
            .setContentText("Data Updated for Saturday")
            .setAutoCancel(true)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        var data = db.collection("user data").document("user data").collection(auth.uid.toString()).document("saturday")
        ///////////////////////////////////////////////////////////////////
        ...
        {
            var intent = Intent(this@saturday,monday_data::class.java)
            startActivity(intent)
        }

        var putdata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("saturday")
        ...
        add.setOnClickListener()
        {
            ...
            done.setOnClickListener()
            {
                ...
                db.collection("user data").document("user data").collection(auth.uid.toString()).document("saturday")
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(dragflag, swipeflag) {
            override fun onMove(
                ...
                var deletedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("saturday")
                deletedata.delete()
                i=1

                val rewritedata = db.collection("user data").document("user data").collection(auth.uid.toString()).document("saturday")
    ...
    {
        var ff = db.collection("user data").document("user data").collection(auth.uid.toString()).document("saturday")
        ...
        ff.get().addOnSuccessListener {
            ...
            if(document.getString("time$i")!=null)
            {
                ...
                var intent = Intent(this, saturdayalarmmanager::class.java)
                intent.putExtra("content title","Saturday Schedule")
